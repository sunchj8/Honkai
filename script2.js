const items = [
    { name: "Гепард", description: "Честный, благородный и справедливый юноша, командир Среброгривых Стражей.", image: "Foto/gepard.jpg" },
    { name: "Броня", description: "Элегантная и утонченная наследница Коколии, Верховной хранительницы Белобога.", image: "Foto/bronya.jpg" },
    { name: "Сервал", description: "Девушка-механик, которая раньше работала на технологический отдел Архитекторов.", image: "Foto/serval.jpg" },
